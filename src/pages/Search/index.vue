    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
          ...
          <!-- 需要传递的参数 1.当前页面currentPageNum  2.每页数量pageSize 3.总数total   4连续页码continueNum，我们可以直接指定并一般是奇数-->
         <Pagination :currentPageNum="searchParams.pageNo"
         :pageSize="searchParams.pageSize"
         :total="goodsListInfo.total"
         :continueNum="5"
         @changePage="changePageNum"></Pagination>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      searchParams: {
        ...
        categoryName: "",
        keyword: "",
        order: "1:desc",   //1代表综合排序   2代表价格排序  asc升序  desc降序
        pageNo: 1,
        pageSize: 4,
        props: [],
        trademark: ""
  ...
  methods: {
    ...
    removeCategoryName(){
      ...
      // this.getGoodsListInfo()  //在这里直接发请求是有问题的，应该让路由去变化
    ...
    removeKeyword(){
      ...
      this.searchParams.pageNo = 1
      this.$bus.$emit('clearKeyword') //使用全局事件总线通知header去清空搜索框
      // this.getGoodsListInfo()   //在这里直接发请求是有问题的，应该让路由去变化
