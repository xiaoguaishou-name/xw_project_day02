  ...
  <div class="trade-container">
    ...
    <div class="trade">
      <div class="price">应付金额:　
        <span>¥{{tradeInfo.totalAmount}}</span></div>
...
import { mapGetters, mapState } from 'vuex'
  export default {
    ...
    methods:{
      ...
      async submitOrder(){
        ...
        let tradeInfo = {
          ...
          deliveryAddress:this.defaultAddress.userAddressList,
          paymentWay:"ONLINE",
        ...
        const result = await this.$API.reqSubmitOrder(tradeNo,tradeInfo)
          if(result.code === 200){
            //请求创建订单成功，会返回一个订单编号，有了这个订单编号，再去跳转到支付页面
    ...
    computed:{
      ...
      defaultAddress(){
        return this.userAddressList.find(item => item.isDefault === '1') || {}  //找到默认地址那一项
      }
    }
  }
</script>
