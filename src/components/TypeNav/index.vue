            ...
            <div class="all-sort-list2" @click="toSearch">
              ...
              >
                <h3>
                  ...
                  >{{c1.categoryName}}</a>
                  <!-- 为什么不适用声明式导航，因为一次性创建了多个组件对象，导致页面卡的一批 -->
...
// import _ from 'lodash'//引入整体，打包体积大
import throttle from "lodash/throttle"; //只引入节流功能
export default {
  name: "TypeNav",
  data() {
    return {
  ...
  methods: {
    ...
    toSearch(event) {
      let data = event.target.dataset; //拿到元素身上所有自定义属性组成的一个对象
